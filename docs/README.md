...
Welcome to the documentation for **Always A (Trivial) Triple Threat (A3T)**!

Here you can find all the necessary rules, reference materials, and technical specifications to host, play, and contribute to the game.
...
The playable trivia database is stored in **[`../data/questions.csv`](../data/questions.csv)**.

If you are interested in contributing new questions, please read the [Question Writer Guidelines](./Question-Writer-Guidelines.md) and review the database schema documentation in [`../data/README.md`](../data/README.md) to ensure your submissions meet the required standards.
